ETNC daemon internationalization
==================================

The Electroneum Classic command line tools can be translated in various languages. If you wish to contribute and need help/support, contact the [Electroneum Classic Localization Workgroup on Taiga](https://taiga.getmonero.org/project/erciccione-monero-localization/) or come chat on `#monero-translations` (Freenode/IRC, riot/matrix, MatterMost)
